            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Thống kê truy cập theo ngày</h3>
                ...
                <div class="box-body">
                  <div class="row">
                    <div class="col-md-12">
                      <p class="text-center">
                        <strong>Thống kê truy cập theo ngày</strong>
                      </p>
              ...
              <div class="box">
                ...
                <div class="box-body">
                  <div class="row">
                    <div class="col-md-12">
                      <p class="text-center">
                        <strong>Thống kê truy cập theo tháng</strong>
                      </p>
                      <div class="chart-responsive">
                        <!-- Sales Chart Canvas -->
		    ...
		    datasets: [
		      {
		        ...
		        data: [65, 59, 80, 81, 56, 55, 40, 25, 25, 26, 23, 12]
		      }
		    ]
		  };
